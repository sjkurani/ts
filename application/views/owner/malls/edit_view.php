    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div>
                ...
                <input name="mall_img" class="form-control" type="file">
            </div>
            <div>
            ...
            <div>
                ...
                <input name="mall_loc" class="form-control" type="text" id="pac-input" type="text" placeholder="Enter a location" value="<?php echo set_value('mall_loc',$mall_loc); ?>">
            </div>
